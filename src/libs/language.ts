export const Language = {
    ...
    'ja': {
        ...
        'capture_entire_page2': 'ページ全体をキャプチャ 2',
        'select_area': 'エリアを選択',
    ...
    'ko': {
        ...
        'capture_entire_page2': '전체 페이지 캡처 2',
        'select_area': '영역 선택',
    ...
    'fr': {
        ...
        'capture_entire_page2': 'Capturer la page entière 2',
    ...
    'es': {
        ...
        'capture_entire_page2': 'Capturar página completa 2',
    ...
    'de': {
        ...
        'capture_entire_page2': 'Gesamte Seite erfassen 2',
    ...
    'it': {
        ...
        'capture_entire_page2': 'Cattura l\'intera pagina 2',
    ...
    'pt': {
        ...
        'capture_entire_page2': 'Capturar página inteira 2',
    ...
    'ru': {
        ...
        'capture_entire_page2': 'Захватить всю страницу 2',
    ...
    'ar': {
        ...
        'capture_entire_page2': 'التقاط صفحة كاملة 2',
    ...
    'hi': {
        ...
        'capture_entire_page2': 'पूरे पृष्ठ को कैप्चर करें 2',
    ...
    'th': {
        ...
        'capture_entire_page2': 'จับภาพหน้าทั้งหมด 2',
    ...
    'vi': {
        ...
        'capture_entire_page2': 'Chụp toàn bộ trang 2',
    ...
    'id': {
        ...
        'capture_entire_page2': 'Tangkap seluruh halaman 2',
    ...
    'en': {
        ...
        'capture_entire_page2': 'Capture entire page 2',
